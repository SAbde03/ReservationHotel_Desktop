    ...
    public PasswordField() {
        ...
        this.addMouseListener(new MouseAdapter() {
            public void mouseEntered(MouseEvent me) {
                PasswordField.this.mouseOver = true;
                PasswordField.this.repaint();
            }

            public void mouseExited(MouseEvent me) {
                PasswordField.this.mouseOver = false;
                PasswordField.this.repaint();
            }
        });
        this.addFocusListener(new FocusAdapter() {
            public void focusGained(FocusEvent fe) {
                PasswordField.this.showing(false);
            }

            public void focusLost(FocusEvent fe) {
                PasswordField.this.showing(true);
            }
        });
        TimingTarget target = new TimingTargetAdapter() {
            public void begin() {
                PasswordField.this.animateHinText = PasswordField.this.getText().equals("");
            }

            public void timingEvent(float fraction) {
                PasswordField.this.location = fraction;
                PasswordField.this.repaint();
            }
        };
